    ...
    plugins: [
      {
        ...
        plugin_root: "/Users/andy/plugins/herdr-dynamic-workflow",
      },
    ],
  },
};
...
test("pluginRootFromListJson reads plugin_root from herdr plugin list --json", () => {
  assert.equal(pluginRootFromListJson(JSON.stringify(listed)), "/Users/andy/plugins/herdr-dynamic-workflow");
});
