/**
 * Error-taxonomy tests, ported from pi-dynamic-workflows v3.5.1 (MIT)
 * tests/errors.test.ts with imports adapted to the vendored engine.
 */
...
describe("wrapError provider-limit classification", () => {
  it("classifies a thrown usage-limit Error as non-recoverable PROVIDER_USAGE_LIMIT (defense for a throwing backend)", () => {
