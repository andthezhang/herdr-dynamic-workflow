...
| `agent()` seven options | inherited exactly; `model`/`effort` become CLI launch flags ([D4](../SPEC.md#d4-launch-options-resolve-before-the-agent-starts)) |
